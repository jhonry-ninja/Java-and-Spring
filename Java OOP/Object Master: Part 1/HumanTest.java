...
public class HumanTest {
	...
	public static void main(String[] args) {
			Human boxer = new Human("Mike Tyson");
			Human martialArtist = new Human("Bruce Lee");
			Human wrestler = new Human("Hulk Hogan");
			
			wrestler.attack(boxer);
			martialArtist.attack(boxer);
			boxer.attack(martialArtist);
	}
}